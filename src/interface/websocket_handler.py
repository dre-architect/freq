...
class WebSocketHandler:
    ...
    def __init__(self, config: Dict[str, Any] = None):
        ...
        """
        self.config = config or {"max_connections": 100, "heartbeat_interval": 30}  # seconds
    ...
    def broadcast_message(self, message: Dict[str, Any]) -> None:
        ...
        _json_message = json.dumps(message)  # noqa: F841
    ...
    def send_alert(self, alert_type: str, alert_message: str) -> None:
        ...
        """
        message = {"type": "alert", "alert_type": alert_type, "message": alert_message}
        self.broadcast_message(message)
    ...
    def send_progress_update(self, cycle_id: int, progress: float) -> None:
        ...
        """
        message = {"type": "progress_update", "cycle_id": cycle_id, "progress": progress}
        self.broadcast_message(message)
